...
import { Car as CarIcon, Users, Fuel, Settings, ArrowRight } from 'lucide-react';
            ...
            {cars.map((mobil, index) => (
              ...
              >
                <div className="relative">
                  <Image
                    src={mobil.mainImage || '/images/mobil-display.png'}
                    alt={mobil.name}
                    width={400}
                    height={192}
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    <Button className="w-full btn-hero" asChild disabled={mobil.status !== 'available'}>
                      <a href={`https://wa.me/628123456789?text=Halo, saya tertarik untuk menyewa ${mobil.name} dengan harga Rp${mobil.price}/${mobil.period || 'hari'}`}>
                        Pesan Sekarang
                      </a>
                    </Button>
                    <Button variant="outline" className="w-full" asChild>
                      <a href={`/kendaraan/${mobil.id}`} className="flex items-center justify-center space-x-2">
